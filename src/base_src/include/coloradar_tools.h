...
//
//    template<PclCloudType<PclPointType> CloudT> CloudT getLidarPointCloud(const std::filesystem::path& binPath);
//    template<OctomapPointType CloudT> CloudT getLidarPointCloud(const std::filesystem::path& binPath);
//    template<PclCloudType<PclPointType> CloudT> CloudT getLidarPointCloud(int cloudIdx);
//    template<OctomapPointType CloudT> CloudT getLidarPointCloud(int cloudIdx);
//
