...
from metrics import DistanceGridOccupancyLoss as PointLoss, ChamferPointDataBuffer as PointDataBuffer
from models import GenerativeFolding as PointModel
...
class PointModelManager(ModelManager):
    ...
    def _define_types(self):
        ...
        self._metric_types = (
            ...
            metric_defs.DistanceLossOccupancyMetric
        )
...
def run(
    ...
    for param_name, param_value in kwargs.items():
        if isinstance(param_value, dict):
            params[param_name].update(param_value)
        else:
